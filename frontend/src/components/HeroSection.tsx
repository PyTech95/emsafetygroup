...
export default function HeroSection({ onNavigate }: HeroProps) {
  ...
  return (
    <section id="hero" className="relative pt-[108px] sm:pt-[120px] overflow-hidden bg-white" data-testid="hero-section">
      ...
      <div className="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-20 lg:pt-12 lg:pb-24">
        <div className="grid lg:grid-cols-[minmax(0,1fr)_minmax(0,2fr)] gap-10 lg:gap-8 xl:gap-12 items-center" data-testid="hero-layout">
          {/* Left copy */}
          <div className="min-w-0" data-testid="hero-copy">
            ...
            >
              <SectionLabel>Benvenuto in E.M Safety</SectionLabel>
            </motion.div>
            <h1
              className="font-display text-neutral-900 font-extrabold leading-[1.06] text-[38px] sm:text-[52px] lg:text-[42px] xl:text-[54px] mt-5 tracking-tight"
              data-testid="hero-heading"
            >
              <MaskedLine delay={0.3}>La sicurezza sul lavoro,</MaskedLine>
            ...
            <motion.p
              ...
              className="font-sans text-[14px] sm:text-[16px] text-neutral-600 leading-relaxed mt-5 max-w-xl"
              data-testid="hero-description"
            >
              Da anni affianchiamo le imprese nella consulenza sulla sicurezza <strong className="text-neutral-900 font-semibold">(D.Lgs 81/08)</strong>,
              nei Sistemi di Gestione Integrati e nella formazione accreditata. Mettiamo al centro le vostre esigenze e la piena conformità normativa.
            </motion.p>
            ...
            >
              <button
                ...
                className="group inline-flex max-w-full items-center justify-center gap-2 px-5 py-3.5 bg-[#1e6fd9] hover:bg-[#155bb0] text-white font-sans text-[14px] font-bold rounded-full shadow-lg transition-[background-color,transform] active:scale-95 cursor-pointer"
              >
            ...
            >
              <span className="inline-flex items-center gap-2" data-testid="hero-compliance">
                <ShieldCheck className="w-4 h-4 text-[#1e6fd9]" /> Conforme D.Lgs 81/08
              </span>
              <span className="inline-flex items-center gap-2" data-testid="hero-offices">
                <PhoneCall className="w-4 h-4 text-[#1e6fd9]" /> Sedi a Treviso &amp; Milano
              </span>
            </motion.div>
          </div>
          ...
          >
            ...
            >
              <div className="font-display text-[28px] font-extrabold text-black leading-none">100%</div>
              <div className="font-sans text-[12px] text-neutral-600 mt-1 leading-snug">
                documentazione a norma e pronta per l&apos;ispezione
              </div>
            </motion.div>
          </motion.div>
        </div>
      ...
      <div className="relative bg-white">
        <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 -mt-10 lg:-mt-14 relative z-10">
            ...
            {VALUES.map((v, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white rounded-2xl border border-slate-200 p-6 shadow-[0_10px_30px_rgba(11,37,69,0.06)] hover:shadow-[0_16px_40px_rgba(11,37,69,0.1)] hover:-translate-y-1 transition-all"
                  data-testid={`value-card-${i}`}
                >
                  <div className="w-11 h-11 rounded-xl bg-[#e8f1fc] border border-[#cfe3f8] flex items-center justify-center text-[#1e6fd9] mb-4">
